...
void Carta::blindaje(Tablero* tablero, Coordenada coord){
    //Inactiva la celda por varios turnos, por lo tanto no se puede hacer ningun
    //movimiento/jugada en ella hasta que vuelva a la actividad.
    tablero->getCelda(coord.getCoordenadaX(),coord.getCoordenadaY(),coord.getCoordenadaZ())->setEstado(false);
    tablero->getCelda(coord.getCoordenadaX(),coord.getCoordenadaY(),coord.getCoordenadaZ())->setTurnosInactiva(4);
}
bool Carta::radar(Tablero* tablero, Coordenada coord){
    ...
    Ficha* comparar1=tablero->getCelda(coord.getCoordenadaX(),coord.getCoordenadaY()-1,coord.getCoordenadaZ())->getFicha();
    if (comparar1-> getTipo()!= Tesoro){
        Ficha* comparar2=tablero->getCelda((coord.getCoordenadaX())+1,coord.getCoordenadaY(),coord.getCoordenadaZ()-1)->getFicha();
        if (comparar2-> getTipo()!= Tesoro){
            Ficha* comparar3=tablero->getCelda((coord.getCoordenadaX())+1,coord.getCoordenadaY(),coord.getCoordenadaZ()+1)->getFicha();
...
void Carta::partirTesoro(Tablero* tablero, Coordenada coord){
    //Parte un Tesoro en dos, cambiando la ficha de la celda inicial a ficha= TesoroPartido
    ...
    tablero-> getCelda(coord.getCoordenadaX(),coord.getCoordenadaY(),coord.getCoordenadaZ())->getFicha()->setTipo(TesoroPartido);
    tablero-> getCelda(coord2.getCoordenadaX(),coord2.getCoordenadaY(),coord2.getCoordenadaZ())->getFicha()->setTipo(TesoroPartido);
}
